...
Basis of classes in uml diagram is completed. Database and APIs parts are still in progress. GUI is being gradually completed.

Göksu Şenerkek - Logic.FoodSelect class and GUI.Login class. I tried some database connections between login page and user database and storage page and food database. They are not completed.
Hayrullah Emre Taş - Logic.Recipe, Logic.Recommendation class, and GUI.MenuBar class. I learned a bit how to use APIs. Some methods of these classes will be completed.
